...
export const AdminServices: React.FC = () => {
    ...
    return (
        <div>
                                            ...
                                            <tr key={service.id} className="border-b hover:bg-gray-50">
                                                ...
                                                <td className="p-2">
                                                    <div className="flex gap-2">
                                                        ...
                                                        <Button variant="ghost" className="text-red-600 text-base border border-gray-200 shadow-none rounded-md px-2 py-0.5" onClick={() => openDeleteConfirmation(service.id)} isLoading={deletingId === service.id}>{deletingId === service.id ? '' : 'Excluir'}</Button>
                                                    </div>
                                                </td>
                                            </tr>
                                        ))}
            ...
            >
                <p>Tem certeza que deseja excluir este serviço? Esta ação removerá o serviço das especialidades de todos os profissionais e não pode ser desfeita.</p>
            </ConfirmationModal>
        </div>
    );
};